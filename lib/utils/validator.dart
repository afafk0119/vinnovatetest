...
class Validator {
  ...
  static String? validateName(String? value) {
    ...
    if (value.isEmpty) {
      print("NAME VALIDATION $value 1");
      return EngTitle.namenull;
    } else if (value.length < 3) {
      return EngTitle.namemustmincharacter;
    } else if (regex.hasMatch(value)) {
      return EngTitle.invaildname;
  ...
  static String? validateEmail(String? value) {
    ...
    if (value == null || value.isEmpty) {
      return EngTitle.emaillnull;
    } else if (!regex.hasMatch(value)) {
      return EngTitle.invaildemail;
    } else {
      return null;
    }
  }
